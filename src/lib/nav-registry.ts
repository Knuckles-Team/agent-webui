...
export const ROUTES: readonly RouteDef[] = [
  ...
  },
  {
    ...
    minRole: 'reader',
    mobile: 'unsupported',
    element: lazy(() => import('@/components/views/Graph3DLodView')),
  },
  {
  ...
  },
  {
    ...
    section: 'admin',
    blurb: "See your own identity and roles, and the fleet's principals and role grants.",
    icon: Users,
    minRole: 'admin',
    mobile: 'unsupported',
    element: lazy(() => import('@/components/views/UserManagementView')),
  },
  {
    id: 'admin.ops',
    path: '/ops',
