    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-12rem)]">
      ...
      <Card className="lg:col-span-1 border-border/40 bg-card/60 backdrop-blur-md flex flex-col overflow-hidden">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            System prompts stored in agent-utilities prompts package.
          </CardDescription>
        ...
        <CardHeader className="border-b border-border/30 pb-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Customize behavior directives, goals, and role specifications.
              </CardDescription>
            </div>
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" onClick={() => void handleSave()} disabled={saving || !promptDetail} className="bg-emerald-600 hover:bg-emerald-700">
              ...
              {editMode === 'form' ? (
                <div className="space-y-6 pb-8">
                  ...
                  <div className="space-y-4 border border-border/20 rounded-xl p-4 bg-muted/5 backdrop-blur-sm">
                    ...
                    <div>
                      <label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Goal / Core Intent</label>
                      <Textarea
                  ...
                  <div className="space-y-4 border border-border/20 rounded-xl p-4 bg-muted/5 backdrop-blur-sm">
                    ...
                    <div>
                      <label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">System Prompt Directive</label>
                      <Textarea
                  ...
                  <div className="space-y-4 border border-border/20 rounded-xl p-4 bg-muted/5 backdrop-blur-sm">
                    ...
                    <div>
                      <label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Active Skill & Tool Tokens</label>
                      <div className="flex flex-wrap gap-1.5 mt-2 p-2 border border-border/20 rounded-lg min-h-[4rem] bg-muted/10 items-start">
                        {(promptDetail.tools || []).length === 0 ? (
                          ...
                          (promptDetail.tools || []).map((tool: string) => (
                            <Badge key={tool} variant="secondary" className="flex items-center gap-1 text-[10px] bg-emerald-500/10 border-emerald-500/20 text-emerald-400 px-2 py-0.75 hover:bg-emerald-500/20 transition-all font-semibold">
                              {tool}
                              <button onClick={() => handleRemoveTool(tool)} className="hover:text-red-400 transition-colors ml-0.5 shrink-0">
                                <X className="size-3" />
                              </button>
                            </Badge>
                          ))
                      ...
                      <div className="flex gap-2 mt-2">
                        ...
                        />
                        <Button size="sm" onClick={handleAddTool} className="h-8 bg-emerald-600 hover:bg-emerald-700 text-xs font-semibold shrink-0">
                          Bind Tool
                        </Button>
                      </div>
                    </div>
