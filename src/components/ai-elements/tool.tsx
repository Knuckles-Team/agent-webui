...
const getStatusBadge = (status: ToolUIPart['state']) => {
  // Every member of `ToolUIPart['state']` must be present: the AI SDK added the
  // human-approval states (`approval-requested` / `approval-responded`) and
  // `output-denied`, and an incomplete map indexes to `undefined` (rendering a
  // blank badge for exactly the states a reviewer most needs to see).
