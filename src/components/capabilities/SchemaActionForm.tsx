          ...
          <div key={name} className="space-y-1.5">
            ...
            {field.enum ? (
              ...
              <Input
                {...common}
                type={
                  field.format === 'password' || field.writeOnly || field['x-sensitive']
                    ? 'password'
                ...
                autoComplete={
                  field.format === 'password' || field.writeOnly || field['x-sensitive'] ? 'new-password' : undefined
                }
