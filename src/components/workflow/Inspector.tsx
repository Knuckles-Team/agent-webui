    ...
    <div className="flex h-full w-64 shrink-0 flex-col border-l border-border/40 bg-muted/10">
      ...
      <ScrollArea className="flex-1">
        <div className="space-y-4 p-3">
          ...
          <div className="space-y-1.5">
            <label className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">Kind</label>
            ...
            <>
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    onPatch(node.id, { config: { model: e.target.value } })
                  }}
                  className="h-8 text-xs"
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  onChange={(e) => {
                    onPatch(node.id, { config: { system_prompt: e.target.value } })
                  }}
          ...
          {(kind === 'step' || kind === 'team' || kind === 'router') && (
            <div className="space-y-1.5">
              <label className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
                Required Capability
              </label>
              <Input
                ...
                onChange={(e) => {
                  onPatch(node.id, { config: { requiredCapability: e.target.value } })
                }}
                className="h-8 text-xs"
              />
            </div>
